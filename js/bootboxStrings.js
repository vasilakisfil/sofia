...
orthodontiki += "<div id=\"cutomHeight\"><h4>Τι είναι η Ορθοδοντική</h4>";
...
τερηδόνα, περιοδοντίτιδα, προβλήματα από τις αρθρώσεις κ.ά.)</p><br />";

orthodontiki += "<h4>Γιατί στον Ορθοδοντικό</h4>";
...
orthodontiki += "<h4>Πότε;</h4>"; 
orthodontiki += "<p class=\"small justify\">\
Η Ορθοδοντική με τις σύγχρονες τεχνικές πλέον απευθύνεται τόσο σε παιδιά όσο και σε ενήλικες οποιασδήποτε ηλικίας. \
Υπάρχουν περιπτώσεις που η ορθοδοντική ενηλικών εφαρμόζεται όχι μόνο για λόγους αισθητικής αλλά και θεραπευτικά για την αντιμετώπιση \
άλλων προβλημάτων υγείας του στοματογναθικού συστήματος. Για τα παιδιά ο πρώτος ορθοδοντικός έλεγχος σύμφωνα με την Αμερικανική Ένωση \
...
η αναμονή μέχρι την πλήρη αντικατάσταση όλων των παιδικών δοντιών από τα μόνιμα για να γίνει η πρώτη επίσκεψη στον ορθοδοντικό</strong></p></div>";
